            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Discover, create, and manage events effortlessly. Connect with
                  like-minded people and build meaningful experiences together
                  with Eventify.
                </p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <Link
                      to={isAuthenticated ? '/add-event' : '/login'}
                      ...
                      {isAuthenticated ? 'Create Event' : 'Learn More'}
                    </Link>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              From creating events to managing attendees, Eventify provides all
              the tools you need.
            </p>
          </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Create and manage events with our intuitive interface. Add
                  details, set dates, and customize your event experience.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Find events easily with our powerful search and filtering
                  system. Search by title, date range, or category.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Track attendees, manage registrations, and see who's joining
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Your data is protected with our custom-built authentication
                  system ensuring privacy and security.
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            ...
            <div className="ml-3 inline-flex rounded-md shadow">
              <Link
                ...
                {isAuthenticated ? 'Browse Events' : 'Learn more'}
              </Link>
            </div>
          </div>
        </div>
